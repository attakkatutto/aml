 ...
 * nodes and m is the number of edges. The number of iterations needed to
 * converge depends on the desired precision.
 *
 ...
 *
 */
public final class PageRank implements DynamicAlgorithm, ElementSink {
     ...
     * @param rankAttribute Rank attribute
     */
     ...
     *
     * @param dampingFactor The new damping factor
     * @throws IllegalArgumentException If the damping factor is less than 0.01
     ...
     * @throws IllegalArgumentException if the precision is less than 1.0e-7
     */
     ...
     *
     * @param rankAttribute The node attribute used to store the computed ranks
     * @throws IllegalStateException if the algorithm is already initialized
     */
